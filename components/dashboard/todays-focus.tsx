      ...
      <CardContent className="space-y-2 sm:space-y-3 p-4 sm:p-6 pt-0">
          ...
          return (
            ...
            >
              ...
              >
                ...
                <span className="hidden sm:inline">Splnit</span>
              </Button>
            </div>
          )
        })}
          ...
          <>
            {pendingHabits.length > 0 && (
              <div className="border-t pt-2 sm:pt-3 mt-2 sm:mt-3">
                <p className="text-xs text-muted-foreground mb-2">Dokončeno</p>
              </div>
            )}
        ...
        {pendingHabits.length === 0 && completedHabits.length > 0 && (
          <div className="text-center py-4 sm:py-6 space-y-2">
            ...
            <p className="font-semibold text-sm sm:text-base">Skvělá práce!</p>
            <p className="text-xs sm:text-sm text-muted-foreground">
              Všechny dnešní návyky splněny
            </p>
          </div>
        )}
      </CardContent>
