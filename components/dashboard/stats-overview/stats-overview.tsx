...
export const StatsOverview = memo(function StatsOverview({
  ...
  const stats = [
    ...
    },
    {
      ...
      helpTitle: t("completedToday"),
      helpContent: t("completedTodayHelp"),
    },
    {
      title: t("weeklyRate"),
