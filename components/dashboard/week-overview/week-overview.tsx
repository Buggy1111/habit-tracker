...
export function WeekOverview({ habits }: WeekOverviewProps) {
  ...
  const tLog = useTranslations("habits.logEntry")
  ...
  const getDayName = (date: Date) => {
    ...
    return t(`dayNames.${dayKeys[date.getDay()]}`)
  }
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <InfoTooltip
                  title={t("weekOverviewTitle")}
                  content={t("weekOverviewHelp")}
                  side="top"
                />
              </div>
              <Badge variant="secondary" className="gap-1 sm:gap-2 text-xs sm:text-sm">
                {t("successRate", { rate: weeklyRate })}
              </Badge>
            </div>
            ...
            <div className="flex items-center justify-between">
              <Button variant="outline" size="sm" onClick={navigateToday} className="gap-2">
                ...
                <span className="hidden sm:inline">{tc("today")}</span>
              </Button>
              <div className="flex items-center gap-2">
                ...
                {daysOfWeek.map((day, index) => {
                  ...
                  return (
                    <button
                      ...
                      title={hasNote ? noteText : tLog("clickToEdit")}
                    >
                      {completed && !hasNote && (
