...
export function WeeklyInsightsCard({ insights }: WeeklyInsightsCardProps) {
  ...
  const getTrendLabel = () => {
    if (insights.trends === "improving") return "Zlepšuješ se"
    if (insights.trends === "declining") return "Pokles"
    return "Stabilní"
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 space-y-4">
        <h3 className="font-semibold text-lg">Přehled týdne</h3>
        ...
        <div className="flex items-center justify-between pt-2 border-t">
          <span className="text-sm text-muted-foreground">Zlepšení oproti minulému týdnu</span>
        ...
        {/* Active Days */}
        <div className="flex items-center justify-between pt-2 border-t">
          <span className="text-sm text-muted-foreground">Aktivních dnů</span>
          ...
          <Card className="p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border-green-300 dark:border-green-700">
            <div className="space-y-2">
              ...
              <p className="text-sm text-green-700 dark:text-green-300">
                {insights.topHabit.completions}/{insights.topHabit.totalDays} dnů (
          ...
          <Card className="p-4 bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20 border-orange-300 dark:border-orange-700">
            <div className="space-y-2">
              ...
              <p className="text-sm text-orange-700 dark:text-orange-300">
                {insights.strugglingHabit.completions}/{insights.strugglingHabit.totalDays} dnů (
                {Math.round(insights.strugglingHabit.completionRate)}%)
              </p>
            </div>
          </Card>
        )}
      ...
      <Card className="p-6 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-lg">Doporučení</h3>
        </div>
