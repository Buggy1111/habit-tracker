  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-2xl">{t("weeklyTitle")}</DialogTitle>
        ...
        <Tabs value={currentTab} onValueChange={setCurrentTab} className="mt-4">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="difficulty" className="gap-2">
              ...
              {t("tabDifficulty")} ({difficultyRatings.size}/{habits.length})
            </TabsTrigger>
          ...
          <TabsContent value="difficulty" className="space-y-6 mt-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-lg font-semibold">{t("rateDifficulty")}</h3>
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button
                  ...
                  className="gap-2"
                >
                  {currentHabitIndex < habits.length - 1 ? tc("next") : t("continue")}
                  <ArrowRight className="h-4 w-4" />
                </Button>
              </div>
            </div>
          ...
          <TabsContent value="reflection" className="space-y-6 mt-6">
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold mb-2">{t("personalReflection")}</h3>
                <p className="text-sm text-muted-foreground">
                  {t("reflectionPrompt")}
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="p-4 bg-muted/50 rounded-lg space-y-2">
                  <p className="text-sm font-medium">{t("reflectionQuestionsTitle")}</p>
              ...
              <div className="flex justify-between pt-4">
                ...
                <Button onClick={handleSubmit} disabled={isSubmitting} className="gap-2">
                  ...
                  {isSubmitting ? t("completing") : t("completeReview")}
                </Button>
              </div>
            </div>
          </TabsContent>
