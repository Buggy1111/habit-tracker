        ...
        <CardContent className="space-y-4 relative">
          ...
          <div className="grid grid-cols-2 gap-3 pt-2 border-t border-white/10">
            <div className="text-center">
              ...
              <p className="text-xs text-muted-foreground">{t("card.habitsCount")}</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-pink-500">{achievedMilestones}</p>
              <p className="text-xs text-muted-foreground">{t("card.milestonesCount")}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {t("card.deleteDesc", { name: identity.title })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              disabled={isDeleting}
            >
              {isDeleting ? t("card.deleting") : t("card.deleteIdentity")}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
