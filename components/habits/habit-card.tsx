...
export const HabitCard = memo(function HabitCard({ habit }: HabitCardProps) {
  ...
  return (
    <Card
      ...
      role="article"
      aria-label={`Návyk: ${habit.name}${habit.completed ? " - dokončeno" : " - nedokončeno"}`}
    >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                aria-label={`Možnosti pro návyk ${habit.name}`}
              >
                <MoreVertical className="h-4 w-4" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={handleEdit}>Upravit</DropdownMenuItem>
              <DropdownMenuItem
      ...
      <CardContent className="space-y-3 sm:space-y-4">
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div
            ...
            role="status"
            aria-label={`Aktuální série: ${habit.streak} ${habit.streak === 1 ? "den" : habit.streak < 5 ? "dny" : "dní"}`}
          >
        ...
        <div
          ...
          role="region"
          aria-label="Vědecké metriky návyku"
        >
          {/* Habit Strength */}
          ...
          {habit.neuroplasticityPhase && (
            <div
              ...
              role="status"
              aria-label={`Neuroplastická fáze: ${habit.neuroplasticityPhase.phase} z 4, ${habit.neuroplasticityPhase.title}`}
            >
              <Brain
        ...
        <Progress
          ...
          aria-label={`Pokrok: ${habit.completed ? "100% dokončeno" : "0% nedokončeno"}`}
        />
          ...
          <Tooltip delayDuration={300}>
            <TooltipTrigger asChild>
              <Button
                ...
                aria-label={
                  habit.completed
                    ? `${habit.name} - dokončeno dnes`
                    : isPending
                      ? "Označuji návyk jako dokončený"
                      : `Označit návyk ${habit.name} jako dokončený`
                }
              >
                {habit.completed ? (
                  <>
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tato akce je nevratná. Návyk "{habit.name}" a všechny jeho záznamy budou trvale
              smazány.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
